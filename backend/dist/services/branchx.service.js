...
exports.isBranchxConfigured = isBranchxConfigured;
exports.normalizeBranchxStatus = normalizeBranchxStatus;
exports.submitBranchxPayout = submitBranchxPayout;
exports.checkBranchxPayoutStatus = checkBranchxPayoutStatus;
...
function redactBranchxObject(input) {
...
function normalizeBranchxStatus(payload) {
...
async function submitBranchxPayout(input) {
    ...
    console.info('[BranchX] payout_request', JSON.stringify({
        url,
...
async function checkBranchxPayoutStatus(requestId) {
    ...
    console.info('[BranchX] payout_status_request', JSON.stringify({
        url,
        requestId: payload.requestId,
        payload: redactBranchxObject(payload),
    }));
